...
- [ ] 监控与告警 (Prometheus/Grafana 基础) <!-- id: 23 -->
...
- [ ] **实战项目:** Web3 移动端钱包后端 (API Gateway) <!-- id: 16 -->

## 9. 高级概念 (MPC & AA)

- [ ] 多签钱包逻辑 (Gnosis Safe 风格) <!-- id: 17 -->
- [ ] 门限签名方案 (TSS/MPC) 概念 Demo <!-- id: 18 -->
...
- [x] **目录结构优化 (internal/server)** <!-- id: 40 -->
  ...
  - _已完成: 文档 `docs/guide_architecture_scalability.md` (路由拆分与任务队列架构)。_
